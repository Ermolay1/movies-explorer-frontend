     ...
     <section>
       <div className={`${isPopupOpen ? "overlay" : ""}`}>
         <nav className={`navigation navigation__popup ${isPopupOpen ? "navigation__popup_open" : ""}`}>
               ...
               <Link to="/" className="navigation__link navigation__link_loggedin navigation__link-main hover-link hover-popup">Главная</Link>
               <NavLink to="/movies" className="navigation__link navigation__link_loggedin hover-link hover-popup" activeClassName="navigation__link_active">Фильмы</NavLink>
               <NavLink to="/saved-movies" className="navigation__link navigation__link_loggedin hover-link hover-popup" activeClassName="navigation__link_active">Сохранённые фильмы</NavLink>
