        ...
        <section>
          ...
          <form className="profile__form">
            ...
            <div className="profile__field">
              ...
              <input className="profile__input" type="email" name="email" placeholder="E-mail" required minLength={6} maxLength={40} />
            </div>
            <button className="profile__button profile__button_submit hover-link" type="submit">Редактировать</button>
            <Link to='/' className="profile__button profile__button_logout hover-link">Выйти из аккаунта</Link>
          </form>
        </section>
      </main>
    )
